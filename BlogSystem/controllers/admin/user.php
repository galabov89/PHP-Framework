    ...
    public function info($userId){
        ...
        if(isset($_POST['deletepost'])){
           // var_dump($_POST['deletepost']);
            ...
            echo '<script type="text/javascript">'. 'var title ='.json_encode($_POST['deletepost']). '</script>';
        ...
        if(isset($_POST['delete_sth'])){

            echo '<p></p>';

            echo '<script type="text/javascript">'. 'var title ='.json_encode('My title'). '</script>';
